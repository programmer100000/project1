...
//initBt3();
//initBt4();
initBt5("component-51");
initBt5("component-52");
initBt5("component-53");
//initBt6();
//initBt7();
//initBt8();
//initBt9();
...
function initBt3() {
    ...
    bt.addEventListener('click', function() {
        ...
        TweenLite.to(bt.querySelectorAll('.button__bg'), 0.9, {
            scale: 1,
...
// Button 5
function initBt5(elm) {
    var bt = document.querySelectorAll('#' + elm)[0];
