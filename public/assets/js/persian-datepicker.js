        ...
        var o = function () {
            ...
            c = function () {
                ...
                return s(e, [{
                    ...
                    value: function (e) {
                        var t = this;
                        if (t.minDate = this.model.options.minDate, t.maxDate = this.model.options.maxDate, t.model.state.filetredDate)
        ...
        ! function (t, i) {
            ...
            n.SUPPORT = "wheel", n.ADD_EVENT = "addEventListener", n.REMOVE_EVENT = "removeEventListener", n.PREFIX = "", n.READY = !1, n.Instance = function (e) {
                ...
                add: function (e, i, a, o) {
                    ...
                    }, e.element[n.ADD_EVENT](n.PREFIX + i, a, o || !1), e.handlers.push({
                        original: s,
                        normalised: a
                    })
                },
        ...
        ! function (i, s) {
            ...
            function d(t, i) {
                ...
                for (var y, b, T, M, S, O, E = new h(t); !E.eos();) {
                    ...
                    if (S = [b, T, y, E.pos], m.push(S), "#" === b || "^" === b) d.push(S);
                    else if ("/" === b) {
            ...
            h.prototype.eos = function () {
                ...
                if (n.hasOwnProperty(e)) i = n[e];
                    ...
                    for (var s, r, l, d = this, c = !1; d;) {
                        if (e.indexOf(".") > 0)
                            for (s = d.view, r = e.split("."), l = 0; null != s && l < r.length;) l === r.length - 1 && (c = a(s, r[l]) || o(s, r[l])), s = s[r[l++]];
                ...
                if (l) {
                    if (f(l))
                        for (var d = 0, c = l.length; d < c; ++d) r += this.renderTokens(e[4], i.push(l[d]), n, a);
                    else if ("object" == typeof l || "string" == typeof l || "number" == typeof l) r += this.renderTokens(e[4], i.push(l), n, a);
                    else if (t(l)) {
