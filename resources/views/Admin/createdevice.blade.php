                            ...
                            <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                                ...
                                @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="edit-system btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#con-خروج-modal" data-id="{{ $t->gnet_device_id }}" data-dtnid="{{ $t->device_type_id }}" data-price="{{ $t->device_name }}">ویرایش</button>
