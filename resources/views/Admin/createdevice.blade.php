            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">افزودن دستگاه</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                            ...
                            <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                                ...
                                @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="edit-system btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal" data-id="{{ $t->gnet_device_id }}" data-dtnid="{{ $t->device_type_id }}" data-price="{{ $t->device_name }}">ویرایش</button>
                                            <button data-id="{{ $t->gnet_device_id }}" type="button" class="btn btn-danger remove-system" data-toggle="modal" data-target="#danger-alert-modal">حذف</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                ...
                <div class="col-xl-6">
                    <div class="card-box">
                        ...
                        <form id="types_form" action="{{ route('create.device') }}"  onsubmit="return false;">
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    <label>نام دستگاه</label>
                                    <input class="form-control" type="text" name="device_name" id="selectize-tags">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
        ...
        <div class="modal-content modal-filled bg-danger">
            <div class="modal-body p-4">
                <div class="text-center">
                    ...
                    <button id="remove-system" data-url="{{ route('delete.device') }}" type="button" class="btn btn-light my-2" data-dismiss="modal">حذف</button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form action="{{ route('edit.device') }}" method="post">
                    <input type="hidden" id="frm_device_type_id" name="gnet_device_id" value="">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="field-2" class="control-label">نام دستگاه</label>
                                <input type="text" name="device_name" class="form-control" id="modal-system-price">
                            </div>
                        </div>
                    </div>
