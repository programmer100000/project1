...
<link rel="stylesheet" type="text/css" href="{{ asset('/ui/css/star-rating-svg.css') }}"> @endsection
@section('content')
<div class=" content">
    <div class="row w-100 m-0 p-0 slider-secttion">
        <div class="inner-slider col d-flex justify-content-center align-items-center ">
            <div class="row w-100 p-0 m-0 justify-content-center">
                <div class=" col-8 col-md-4 p-0 pl-1  searchbar d-flex justify-content-center align-items-center"
                    dir="rtl">
                    <input class="search_input border-0" type="text" name="" placeholder="جستجو...">
                    <a href="#" class="search_icon d-flex justify-content-center text-white align-items-center"><i
        ...
        <div class="row w-100 m-0 plan-header main-page-plan-header">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="774" viewBox="0 0 1944 774">
                <path id="Path_1645" width="100%" data-name="Path 1645"
        ...
        <div class="row plan-body w-100  m-0  justify-content-center">
            <div class="col-md-8 d-flex justify-content-center p-0">
                <div class="row w-100 p-4 m-0 justify-content-center">
                    <div
                        class="col-lg mx-lg-3 mx-0 my-5 my-lg-0   d-flex align-items-stretch p-0 justify-content-center">
                        <div class="plan first-plan d-block text-center">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
                                        <g id="Group_312" data-name="Group 312" transform="translate(-341.389 -640.5)">
                                            <circle id="Oval" cx="20.5" cy="20.5" r="20.5"
                                                transform="translate(342.889 642)" fill="none" stroke="#f8bc53"
                                                stroke-miterlimit="10" stroke-width="3" />
                                            <path id="Combined_Shape" data-name="Combined Shape"
                                                d="M10.236,17.742H2.048a2.047,2.047,0,1,1,0-4.094H8.188V2.048a2.048,2.048,0,1,1,4.1,0V15.694a2.047,2.047,0,0,1-2.047,2.048Z"
                                                transform="translate(366.321 649.548) rotate(45)" fill="#f8bc53" />
                                        </g>
                                    </svg>
                                </div>
                            ...
                            <div class="row m-0 p-0 justify-content-center">
                                <a type="button" class=" plan-btn khorshid"
                                    href="{{ route('admin.register') }}/#plan1">خرید</a>
                    ...
                    <div class="col-lg mx-lg-3 mx-0 my-5 my-lg-0 p-0 d-flex align-items-stretch justify-content-center">
                        <div class="plan d-block text-center">
                                ...
                                <div class="col-2 m-0 p-0 icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
                                        <g id="Group_313" data-name="Group 313" transform="translate(-341.444 -640.5)">
                                            <circle id="Oval" cx="20.5" cy="20.5" r="20.5"
                                                transform="translate(342.944 642)" fill="none" stroke="#3897ec"
                                                stroke-miterlimit="10" stroke-width="3" />
                                            <path id="Combined_Shape" data-name="Combined Shape"
                                                d="M10.236,17.742H2.048a2.047,2.047,0,1,1,0-4.094H8.188V2.048a2.048,2.048,0,1,1,4.1,0V15.694a2.047,2.047,0,0,1-2.047,2.048Z"
                                                transform="translate(366.321 649.548) rotate(45)" fill="#3899ee" />
                                        </g>
                                    </svg>
                            ...
                            <div class="row m-0 p-0 justify-content-center">
                                ...
                                <a type="button" class=" plan-btn almas"
                                    href="{{ route('admin.register') }}/#plan2">خرید</a>
                    ...
                    <div class="col-lg mx-lg-3 mx-0 my-5 my-lg-0 p-0 d-flex align-items-stretch justify-content-center">
                        <div class="plan d-block text-center">
                                ...
                                <div class="col-2 m-0 p-0 icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
                                        <g id="Group_314" data-name="Group 314" transform="translate(-341.5 -432.5)">
                                            <circle id="Oval" cx="20.5" cy="20.5" r="20.5"
                                                transform="translate(343 434)" fill="none" stroke="#c454fa"
                                                stroke-miterlimit="10" stroke-width="3" />
                                            <path id="Combined_Shape" data-name="Combined Shape"
                                                d="M10.236,17.742H2.048a2.047,2.047,0,1,1,0-4.094H8.188V2.048a2.048,2.048,0,1,1,4.1,0V15.694a2.047,2.047,0,0,1-2.047,2.048Z"
                                                transform="translate(366.321 441.627) rotate(45)" fill="#8f4eab" />
                                        </g>
                                    </svg>
                            ...
                            <div class="row m-0 p-0 justify-content-center">
                                ...
                                <a type="button" class=" plan-btn kahkeshan"
                                    href="{{ route('admin.register') }}/#plan3">خرید</a>
        ...
        <div class="row about-body w-100 p-4 pt-4 m-0  ">
            <div class="col-md-7 p-4  about top-about ">
                ...
                <div class=" text-justify text-white">
                    ...
                    و اندازه فونت و ظاهر متن باشد. معمولا طراحان گرافیک برای صفحه‌آرایی، نخست از متن‌های آزمایشی و
    ...
    <div class="row w-100 mx-0 contact-secttion d-flex justify-content-center align-items-center">
        <div class="col-md-8 col-lg-4  ">
            ...
            <p class="text-white text-justify">برای ارتباط با ما پیغام خود را برای ما ارسال کنید.همکاران ما در اولین
                فرصت پاسخگوی شما هستند.</p>
        </div>
        <div class="col-md-8 col-lg-4  p-3 main-contact ">
            <form class="main-contact-form">
                <input type="text" class="form-control mb-4 text-white" id="name" placeholder="نام و نام خانوادگی"
                    name="name">

                <input type="text" class="form-control mb-4 text-white" id="email" placeholder="ایمیل/شماره موبایل"
                    name="email">
                <textarea class="form-control mb-4" rows="5" id="comment" placeholder="متن مورد نظر"></textarea>
                <div class="row mb-4">
                    <div class="col-8">
                        <input type="text" class="form-control  text-white" id="captcha" placeholder="کد کپچا"
                            name="captcha">
        ...
        <div class="modal-content modal-filled bg-danger">
            <div class="modal-body p-4">
                <div class="text-center">
                    ...
                    <button id="btnrate" data-csrf={{ csrf_token() }} data-url="{{ route('gamenet.rate') }}"
                        type="button" class="btn btn-light my-2" data-dismiss="modal">ثبت‌</button>
                </div>
            </div>
        </div>
        <!-- /.modal-content -->
...
<svg xmlns="http://www.w3.org/2000/svg" width="1944" height="774" viewBox="0 0 1944 774">
    <path id="Path_1645" data-name="Path 1645"
        d="M0,0S331.681,322,1007.612,279.333,1944,0,1944,0V774s-450.388-182-936.388-182S0,774,0,774Z" fill="#231553">
    </path>
</svg>
@endsection
