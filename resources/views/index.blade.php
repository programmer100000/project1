    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="demo m-auto w-100">
                <div class="container ">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 wow animate__slideInLeft" data-wow-duration="3s">
                            <div class="pricingTable green">
                                ...
                                <div class="pricing-content">
                                    ...
                                    <a href=""><button id="component-51"
                                            class="button button--5 pricingTable-signup">سفارش</button></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 wow animate__slideInLeft" data-wow-duration="1s">
                            <div class="pricingTable green">
                                <div class="pricingTable-header">
                                    <div class="price-value">
                                        <span class="amount">100</span>
                                ...
                                <div class="pricing-content">
                                    ...
                                    <a href=""><button id="component-52"
                                            class="button button--5 pricingTable-signup">سفارش</button></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 wow animate__slideInRight" data-wow-duration="1s">
                            <div class="pricingTable green">
                                <div class="pricingTable-header">
                                    <div class="price-value">
                                        <span class="amount">100</span>
    ...
    <section class="page-section slider back-dark" id="gamenets">
        <div class="row m-0 p-0">
            @foreach($gamenets_active as $ga)
                <a class="" href="/gamenet/{{ $ga->gamenet_id }}/{{ $ga->title }} ">
